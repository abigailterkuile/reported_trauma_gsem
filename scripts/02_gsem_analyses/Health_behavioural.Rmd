...
traits <- c(
"data/CTS_noMHC.sumstats.gz",
"data/TIRE01_noMHC.sumstats.gz", 
"data/SUBJ01_noMHC.sumstats.gz",
"data/RISK03_noMHC.sumstats.gz",
"data/RISK01_noMHC.sumstats.gz",
"data/INCO03_noMHC.sumstats.gz", 
"data/HEAL01_noMHC.sumstats.gz",
"data/REPR01_noMHC.sumstats.gz",
"data/SMOK06_noMHC.sumstats.gz",
"data/NEUR02B_noMHC.sumstats.gz",
"data/INSO02_noMHC.sumstats.gz",  
"data/INCO01_noMHC.sumstats.gz",
"data/LONG04_noMHC.sumstats.gz",
"data/LONG01_noMHC.sumstats.gz")

#Sample prevalence
sample.prev <- c(NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, .28, NA, NA, NA)

#Population prevalence
population.prev <- c(NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, .30, NA, NA, NA)
...
# Set trait names
trait.names<-c("CTS", "Tiredness", "Subj. wellbeing", "Sexual partners", "Risk", "Social dep", "Health", "Age first birth", "Ever smoker", "Neuroticism", "Insomnia", "Household income", "Parents attained age", "Parents age death")
